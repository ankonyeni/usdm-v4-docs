...
<div class="sdtm-detail-card">
  <p class="sdtm-detail-meta"><strong>Label:</strong> Obs Study Population Description</p>
  <p class="sdtm-detail-meta"><strong>USDM Class:</strong> <a href="../../../classes/StudyDesignPopulation/">StudyDesignPopulation</a></p>
  <p class="sdtm-detail-meta"><strong>USDM Path:</strong> <code>StudyVersion/@studyDesigns/StudyDesign/@population/StudyDesignPopulation/@description</code></p>
</div>
