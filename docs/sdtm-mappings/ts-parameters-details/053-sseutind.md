...
<div class="sdtm-rule-list"><p><strong>Condition Notes:</strong> If count is 1 then set to &#x27;Yes&#x27;</p><p><strong>Condition Path:</strong> <code>Organization/@managedSites /StudySite/@country/Code/@code in {European country codes}</code></p></div>
